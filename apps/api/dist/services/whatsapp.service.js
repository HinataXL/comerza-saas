...
const sendReservationWhatsApp = async (params) => {
...
Para cancelar tu reservación, responde con *CANCELAR*.`;
    try {
        ...
        logger_service_1.logger.info('Mensaje de WhatsApp enviado vía Twilio con SID:', response.sid);
        return response;
    }
    catch (error) {
        logger_service_1.logger.error('Error al enviar WhatsApp con Twilio:', error.message);
        throw error;
    }
};
