import { SubscriptionGateway, SubscriptionCheckoutRequest, SubscriptionCheckoutResponse } from '../subscription-gateway.interface';

export class RecurrenteSubscriptionGateway implements SubscriptionGateway {
  
  async createSubscriptionCheckout(request: SubscriptionCheckoutRequest): Promise<SubscriptionCheckoutResponse> {
